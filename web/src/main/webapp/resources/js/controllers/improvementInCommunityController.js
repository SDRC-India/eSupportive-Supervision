...
function reportController($scope, $http, $filter ,$timeout, $window,$compile) {
	...
	$scope.pageName = "Report > Improvement In Community";
	$scope.activeMenu = "improvementCommunity";
    ...
    */
	...
	$scope.getFacilityData = function(rowData,timeId){
		$("#loader-mask").show();
	...
	$scope.exportTableData = function(id, facility, block){
        ...
        var tab_text = "<h2>Improvement In Community</h2><h3>Checklist: "+$scope.savedSelectedChecklist.value+"</h3>"+ (facility?"<h3>Facility: "+facility+", "+ block +"</h3>":"") +"<h3>Location: " + $scope.savedSelectedDistrict.name + ", " +$scope.savedSelectedState.name +"</h3>";
        if(id == "dataTable"){
        ...
        if(id=="dataTable"){
        	link.download = "improvement_in_Community_" + $scope.savedSelectedState.name +"_" + new Date().toLocaleDateString() + ".xls";
        }else{
        	link.download = "improvement_in_Community_" + $scope.savedSelectedState.name +"_" + $scope.facility + "_" + new Date().toLocaleDateString() + ".xls";
        }
