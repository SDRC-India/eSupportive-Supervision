...
.plan-action input:focus {
				...
				<table items="tabledata" show-filter="true" cellpadding="0"
					...
					<thead>
						<tr>
							...
							<th class="deg-mgmt-table-head" nowrap>No.&nbsp;of action open
								<div class="sorting1" ng-click="order('No.of action open')">
									<i class="fa fa-caret-up fa-lg asc" aria-hidden="true"
										ng-class="{'hiding': sortReverse == true || (sortType != 'No.of action open' &&  sortReverse == false)}"></i>
									<i class="fa fa-caret-down fa-lg dsc" aria-hidden="true"
										ng-class="{'hiding': sortType == 'No.of action open' &&  sortReverse == false}"></i>
								</div>
							</th>
							<th class="deg-mgmt-table-head" nowrap>No. of action closed
								<div class="sorting1" ng-click="order('No. of action closed')">
									<i class="fa fa-caret-up fa-lg asc" aria-hidden="true"
										ng-class="{'hiding': sortReverse == true || (sortType != 'No. of action closed' &&  sortReverse == false)}"></i>
									<i class="fa fa-caret-down fa-lg dsc" aria-hidden="true"
										ng-class="{'hiding': sortType == 'No. of action closed' &&  sortReverse == false}"></i>
								</div>
							</th>
					...
					<tbody id="myTable">
						<tr
							...
							<td class="pdsa-table" ng-repeat="column in coloumns"
								sortable="'{{rowData[column]}}'"
								ng-click="column=='Facility Name'?getFacilityData(rowData):''"
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-body modal-body-padding">
						...
						<div class="report-modal-title text-md-left">
							...
							<div
								...
								<div class="col-md-6 col-xs-12 text-right">
									...
									<div class="select-container  text-center" style="margin: 0px">
										<div class="input-group" style="margin: auto;">
						...
						<div
							class="tableMargin table-responsive faility-action-table all-table-height header-fixed-table"
							style="width: 100%; overflow: auto;"
	...
	<script type="text/javascript"
		src="resources/js/controllers/planActionReport.js"></script>
	<script type="text/javascript">
