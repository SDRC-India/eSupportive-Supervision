...
<title>Improvement In Facility</title>
...
.plan-action input:focus {
			...
			<div
				...
				<div class="col-md-4 col-xs-12 text-md-right text-sm-left">
					<h5 style="font-weight: bold;">Total no. of Facilities :
						{{reportTableData.length}} &nbsp; out of &nbsp; {{facilities}}</h5>
				</div>
					...
					<tbody id="myTable">
						<tr
							...
							<td class="pdsa-table" 
								...
								>
								{{rowData['area']}}</td>
								<td class="pdsa-table report-table-span"  sortable="'facility'" ng-click="getFacilityData(rowData)">
								{{rowData['facility']}}</td>
								<td class="pdsa-table"  sortable="'facilityType'" >
								{{rowData['facilityType']}}</td>
								<td class="pdsa-table" sortable="'baseline'"
								>
								{{rowData['baseline']}}</td>
								<td class="pdsa-table" sortable="'t-2'"
								>
								{{rowData['t-2']?rowData['t-2']:'-'}}</td>
								<td class="pdsa-table" sortable="'t-1'"
								>
								{{rowData['t-1']?rowData['t-1']:'-'}}</td>
								<td class="pdsa-table" sortable="'t'"
								>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-body modal-body-padding">
						...
						<div
							class="tableMargin table-responsive faility-action-table header-fixed-table all-table-height"
							style="width: 100%; overflow: auto;"
							sdrc-table-header-fix tableuniqueclass="'faility-action-table'"
							...
							<table items="tableData" show-filter="true" cellpadding="0"
								...
								<thead>
									<tr>
										...
										<th style="position: relative;">Section/Sub-section
											<div class="sorting1" ng-click="orderFacilityModal('facilityName')">
												<i class="fa fa-caret-up fa-lg asc" aria-hidden="true"
													ng-class="{'hiding': sortReverse1 == true || (sortType1 != 'facilityName' &&  sortReverse1 == false)}"></i>
												<i class="fa fa-caret-down fa-lg dsc" aria-hidden="true"
													ng-class="{'hiding': sortType1 == 'facilityName' &&  sortReverse1 == false}"></i>
											</div>
										</th>
										<th style="position: relative;">Baseline
											<div class="sorting1" ng-click="orderFacilityModal('baseline')">
												<i class="fa fa-caret-up fa-lg asc" aria-hidden="true"
													ng-class="{'hiding': sortReverse1 == true || (sortType1 != 'baseline' &&  sortReverse1 == false)}"></i>
												<i class="fa fa-caret-down fa-lg dsc" aria-hidden="true"
													ng-class="{'hiding': sortType1 == 'baseline' &&  sortReverse1 == false}"></i>
											</div>
										</th>
										<th style="position: relative;">T - 2
											<div class="sorting1" ng-click="orderFacilityModal('t-2')">
												<i class="fa fa-caret-up fa-lg asc" aria-hidden="true"
													ng-class="{'hiding': sortReverse1 == true || (sortType1 != 't-2' &&  sortReverse1 == false)}"></i>
												<i class="fa fa-caret-down fa-lg dsc" aria-hidden="true"
													ng-class="{'hiding': sortType1 == 't-2' &&  sortReverse1 == false}"></i>
											</div>
										</th>
										<th style="position: relative;">T - 1 
											<div class="sorting1" ng-click="orderFacilityModal('t-1')">
												<i class="fa fa-caret-up fa-lg asc" aria-hidden="true"
													ng-class="{'hiding': sortReverse1 == true || (sortType1 != 't-1' &&  sortReverse1 == false)}"></i>
												<i class="fa fa-caret-down fa-lg dsc" aria-hidden="true"
													ng-class="{'hiding': sortType1 == 't-1' &&  sortReverse1 == false}"></i>
											</div>
										</th>
										<th style="position: relative;">T (Most Recent)
											<div class="sorting1" ng-click="orderFacilityModal('t')">
												<i class="fa fa-caret-up fa-lg asc" aria-hidden="true"
													ng-class="{'hiding': sortReverse1 == true || (sortType1 != 't' &&  sortReverse1 == false)}"></i>
												<i class="fa fa-caret-down fa-lg dsc" aria-hidden="true"
													ng-class="{'hiding': sortType1 == 't' &&  sortReverse1 == false}"></i>
											</div>
										</th>
								...
								<td class="pdsa-table01"  sortable="'facilityName'"
								>
								{{rowData['facilityName']}}</td>
								<td class="pdsa-table1" sortable="'baseline'" 
								>
								{{rowData['baseline']}}</td>
								<td class="pdsa-table1" sortable="'t-2'"
								>
								{{rowData['t-2']?rowData['t-2']:'-'}}</td>
								<td class="pdsa-table1" sortable="'t-1'"
								>
								{{rowData['t-1']?rowData['t-1']:'-'}}</td>
								<td class="pdsa-table1" sortable="'t'"
								>
								{{rowData['t']?rowData['t']:'-'}}</td>
									</tr>
								</tbody>
	...
	<script type="text/javascript"
		src="resources/js/controllers/improvementInFacilityController.js"></script>
	<script type="text/javascript">
